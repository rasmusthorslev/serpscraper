...
SECRET_KEY = 'django-insecure-80tw4)!u03mkn#12(0g#dvl04@++&^zc+_@8x6y0ne7n3-c@y0'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ranktracker',
        'USER': 'rthorslev',         # Must match POSTGRES_USER
        'PASSWORD': '#Er45r5rpopo!123', # Must match POSTGRES_PASSWORD
